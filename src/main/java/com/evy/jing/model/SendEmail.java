...
public class SendEmail {
    ...
    static MimeMessageHelper mimeMessageHelper;
    static JavaMailSender mailSender;
    static SeUserService seUserService;
    static JedisCache cache;

    public static void setMimeMessageHelper(MimeMessageHelper mimeMessageHelper) {
        SendEmail.mimeMessageHelper = mimeMessageHelper;
    }

    public static void setJavaMailSender(JavaMailSender javaMailSender) {
        SendEmail.mailSender = javaMailSender;
    }

    public static void setSeUserService(SeUserService seUserService) {
        SendEmail.seUserService = seUserService;
    }

    public static void setCache(JedisCache cache) {
        SendEmail.cache = cache;
    }

    @PostConstruct
    private void init(){
        setMimeMessageHelper(helper);
        setJavaMailSender(sender);
        setSeUserService(userService);
        setCache(jedisCache);
    }
    ...
    static final String RESET_PASSWORD_URL = "http://localhost:8080/resetPassword";
